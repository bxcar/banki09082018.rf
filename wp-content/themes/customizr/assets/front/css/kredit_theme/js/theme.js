...
function change_2(cart) {
    console.log("Показываем таблицу");

    var sum_credit = $("#price-2").val();
    var srok_credit = $("#cur_period-2").val();
    // var credit_link = $("#credit_link").val();
    ...
    var g = document.querySelector('#cur_gr-2');
    path_theme = document.getElementById('id_theme-2').value;
    currency_credit = document.getElementById('cur_currency-2').value;
    cur_target = document.getElementById('cur_target-2').value;
    cur_slpr = document.getElementById('zalog_cur-2').value;
    cur_guarantee = document.getElementById('cur_poruch-2').value;
    cur_spravka = document.getElementById('cur_podtv_dohod-2').value;
    cur_form_vidach = document.getElementById('cur_form_vidach-2').value;
    cur_srok_rasm = document.getElementById('cur_srok_rasm-2').value;

    cur_registr = document.getElementById('cur_registr-2').value;
    cur_agestart = document.getElementById('cur_age-2').value;
    cur_category = document.getElementById('cur_category-2').value;
    cur_stag = document.getElementById('cur_stag-2').value;
    cur_stag_last = document.getElementById('cur_stag_last-2').value;

    cur_city = document.getElementById('cur_city_dop-2').value;
    ...
    table = table + "</ul>";
    footer_dop = "<button class='_2sdWW _2OZ3R RaZ2S _3zDyU _3x77s' type='button' data-test='ui-button' onclick='close_dop_2()'>Найдено " + kol + " </button><button  class='_2sdWW _2OZ3R _1VABv _3zDyU _3x77s' type='button' data-test='ui-button' onclick='clear_dop_2()'>Сбросить фильтры</button>";
    document.getElementById("list_bank-2").innerHTML = table;
    document.getElementById("footer_dop_cr-2").innerHTML = footer_dop
}
// });
