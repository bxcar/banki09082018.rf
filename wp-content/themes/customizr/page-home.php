...
<div id="tc-page-wrap" class="">
    ...
    <div class="content_page">
        ...
        <!--newtable-->
        <div data-reactid="151" style="margin-bottom:120px" id="credits-compare-2"><!-- react-empty: 152 -->
            <section class="_2rXEs aqIhJ calculator-list-theme__wrapper">
                <div class="_20jzZ">
                    <div class="_3n9UL calculator-list-theme__image-container"></div>
                </div>
                    ...
                    <div class="_2BsQ1">
                        ...
                        <div class="_30VPM">
                            <div class="WXTuD _Szkx fx">
                                ...
                                <div class="" data-test="ui-group">
                                    <div class="_2J6fq">
                                        <div class="_1Mbqb _2futP _2mpBR fx" data-test="ui-slider-input">
                                            <div class="_3_n91 AePXT _1fswf" data-test="ui-slider-input-input"><input
                                                        id="price-2" class="_2ARmF _2qJ6u _3uy56 _3I6R2" name="price"
                                                        value="500000" onkeypress="price_change_2()"
                                                        style="width:100%;"><input id="oldprice-2"
                                                                                   class="_2ARmF _2qJ6u _16cFN"
                                                                                   name="oldprice" type="hidden"><input
                                                        id="oldprice1-2" class="form-control" name="oldprice1"
                                                        type="hidden">
                                    ...
                                    <div data-test="ui-select" class="_129hA _129hA-fx">
                                        <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input">
                                            <div class="_1DCZo">
                                                <div data-test="ui-select" class="_129hA _2futP _1iN3s">
                                                    <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input">
                                                        <div class="_1DCZo"><input id="cur_currency-2" type="text"
                                                                                   readonly=""
                                                                                   autocomplete="off" autocorrect="off"
                                                                                   autocapitalize="off" spellcheck="off"
                                                                                   class="_2ARmF _2qJ6u _16cFN "
                                                    ...
                                                    <ul id="currency-2" class=" _2cR3J" data-test="ui-select-values">
                                                        <li value="RUB" class="_3NNjg" data-test="ui-menu-item"
                                                            onclick="select_currency_2('&#8381;')"><i class="fa fa-rub"
                                                                                                      aria-hidden="true"></i>
                                                        </li>
                                                        <li value="USD" class="_3NNjg" data-test="ui-menu-item"
                                                            onclick="select_currency_2('&#36;')"><i class="fa fa-usd"
                                                                                                    aria-hidden="true"></i>
                                                        </li>
                                                        <li value="EUR" class="_3NNjg" data-test="ui-menu-item"
                                                            onclick="select_currency_2('&euro;')"><i class="fa fa-eur"
                                                                                                     aria-hidden="true"></i>
                                                        </li>
                                                    </ul>
                                                </div>
                            ...
                            <div class="WXTuD">
                                ...
                                <div data-test="ui-select" class="_129hA _129hA-fx">
                                    <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input">
                                        <div class="_1DCZo"><input id="cur_period-2" type="text" readonly=""
                                                                   autocomplete="off" autocorrect="off"
                                                                   autocapitalize="off"
                                                                   spellcheck="off" class="_2ARmF _2qJ6u _16cFN"
                                                                   role="input" value="3 года"
                                                                   onclick="select_period_2();">
                                            <div class="_2k11- _2V6_I _3E_jV SVDVr _2Z7K9"
                                                 data-test="ui-select-input-icon">
                                                <svg class="SdEDi">
                                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                    ...
                                    <ul id="period-2" class="_3IKDE _2cR3J" data-test="ui-select-values">
                                        <li value="P1M" label="1 месяц" class="_3NNjg" data-test="ui-menu-item"
                                            data-reactid="205" onclick="select_period_srok_2('1 месяц')">1 месяц
                                        </li>
                                        <li value="P3M" label="3 месяца" class="_3NNjg " data-test="ui-menu-item"
                                            onclick="select_period_srok_2('3 месяца')">3 месяца
                                        </li>
                                        <li value="P6M" label="6 мес¤цев" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('6 месяцев')">6 месяцев
                                        </li>
                                        <li value="P9M" label="9 месяцев" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('9 месяцев')">9 месяцев
                                        </li>
                                        <li value="P1Y" label="1 год" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('1 год')">1 год
                                        </li>
                                        <li value="P2Y" label="2 года" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('2 года')">2 года
                                        </li>
                                        <li value="P3Y" label="3 года" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('3 года')">3 года
                                        </li>
                                        <li value="P4Y" label="4 года" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('4 года')">4 года
                                        </li>
                                        <li value="P5Y" label="5 лет" class="_3NNjg" data-test="ui-menu-item"
                                            data-reactid="213" onclick="select_period_srok_2('5 лет')">5 лет
                                        </li>
                                        <li value="P6Y" label="6 лет" class="_3NNjg" data-test="ui-menu-item"
                                            data-reactid="214" onclick="select_period_srok_2('6 лет')">6 лет
                                        </li>
                                        <li value="P7Y" label="7 лет" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('7 лет')">7 лет
                                        </li>
                                        <li value="P8Y" label="8 лет" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('8 лет')">8 лет
                                        </li>
                                        <li value="P9Y" label="9 лет" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('9 лет')">9 лет
                                        </li>
                                        <li value="P10Y" label="10 лет" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('10 лет')">10 лет
                                        </li>
                                        <li value="P15Y" label="15 лет" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('15 лет')">15 лет
                                        </li>
                                        <li value="P20Y" label="20 лет" class="_3NNjg" data-test="ui-menu-item"
                                            onclick="select_period_srok_2('20 лет')">20 лет
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="WXTuD _129hA-fx1" data-reactid="221">
                                <button onclick="show_dop_2()"
                                        class="_2sdWW calculator-list-theme__button-conditions _1VABv _3zDyU _3x77s"
                                        type="button" data-test="ui-button" data-reactid="222">+ Еще условия
                                </button>
                            </div>
                            <div class="WXTuD _1mLgv _129hA-fx1" data-reactid="223">
                                <button href="#table-fx-2"
                                        class="_2sdWW calculator-list-theme__button-selection RaZ2S _3zDyU _3x77s"
                                        type="button" data-test="ui-button" data-reactid="224"><span class="zTFG-"
                                                                                                     data-reactid="225">Подобрать</span><span
                                            class="-I2py" data-reactid="226"><svg class="_2MAZT" data-reactid="227"><use
                        ...
                        <div style="margin:30px; display: none;"><a class="dop_" onclick="show_dop_2()"> Дополнительные
                                условия <i
                                        class="fa fa-angle-down"></i></a></div>
            </section>
            <div data-reactid="270" id="sort-params-2">
                <div style="padding-bottom: 0;" data-reactid="271"></div>
                <div class="_3ThEC _7ol--" style="transform: translateZ(0px);" data-reactid="272">
                    <div class="_1Xn7Q" data-reactid="273">
                        <span class="" data-reactid="274"><!-- react-text: 275 -->Сортировка:<!-- /react-text --></span>
            ...
            <div style="border-bottom:1px solid #fff6f6" id="table-fx-2">
                <div class="navbar-component" data-current="1">
                    <div class="navbar area">
                        <nav role="navigation" id="navigation-2" class="list"><a href="javascript:void(0);"
                                                                                 class="item -link-2 -active-2"
                                                                                 onclick="toggle_menu_2('1');Get_OnKr()">Популярные</a>
                            <a href="javascript:void(0);" class="item -link-2" onclick="toggle_menu_2('2');Get_OnKr()">Все
                                банки</a><!-- <span class="item"><i class="fa fa-search"></i></span> -->
                        </nav>
                    </div>
                </div>
            </div>
            <input id="id_theme-2" name="id_theme" type="hidden" value="<? echo get_template_directory_uri() ?>">
            <div id="list_bank-2"></div>
            <a href="#" id="loadMore-2">Загрузить больше предложений&nbsp;
                <svg data-cust-att="sort-parameter" data-type="rate" width="16" height="16" viewBox="0 0 1792 1792"
                     xmlns="http://www.w3.org/2000/svg">
                    <path d="M1395 736q0 13-10 23l-466 466q-10 10-23 10t-23-10l-466-466q-10-10-10-23t10-23l50-50q10-10 23-10t23 10l393 393 393-393q10-10 23-10t23 10l50 50q10 10 10 23z"></path>
                </svg>
...
<!--newdoptable-->
<div class="_2Jclz _2fZko _1odi0 _3m0xh" id="overlay-2" style="display:none;">
    <div class="ud9DQ _21AWC _2t8V0"></div>
    <div class="_2TVkK  _3BjeW _3dfdz _2Muap">
        <section class="_2tiCJ">
            <div>
                <div class="_20lkO">
                    <div class="_282xc">
                        <div class="_321bS">
                            <div class="_1FhHf"><i class="fa fa-times-circle-o" aria-hidden="true"
                                                   style="font-size:40px" onclick="close_dop_2()"></i></div>
                            <div class="_1bMAp">
                                <div class="_1-qkH">
                                    <div class="_261bl">
                                        <div class="smgEc _1MiQb">Все условия</div>
                                        <div class="_3W8tQ">
                                            <div class="_1rc8I" data-test="ui-group">
                                                ...
                                                <div class="_2J6fq">
                                                    <div class="_1Mbqb _2futP TNUZk" data-test="ui-slider-input">
                                                        <div class="_3_n91 AePXT _1fswf"
                                                             data-test="ui-slider-input-input">
                                                            <div class="_1DCZo"><input id="price_dop-2"
                                                                                       class="_2ARmF _2qJ6u _3uy56 _3I6R2"
                                                                                       name="price_dop"
                                                                                       onkeypress="price_change_dop_2()">
                                                                <div id="slider-range_dop-2"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="_1rc8I " data-test="ui-group">
                                                ...
                                                <div class="_2J6fq">
                                                    <div class="_1Mbqb _2futP TNUZk" data-test="ui-slider-input">
                                                        <div class="_3_n91 AePXT _1fswf"
                                                             data-test="ui-slider-input-input">
                                                            <div class="_1DCZo"><input id="cur_currency_dop-2" type="text"
                                                                                       readonly="" autocomplete="off"
                                                                                       autocorrect="off"
                                                                                       autocapitalize="off"
                                                                                       spellcheck="off"
                                                                                       class="_2ARmF _2qJ6u _16cFN "
                                                                                       value="&#8381;"
                                                                                       onclick="select_cur_dop_2();">
                                                                <ul id="currency_dop-2" class=" _2cR3J"
                                                                    data-test="ui-select-values">
                                                                    <li value="RUB" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_currency_dop_2('&#8381;')"><i
                                                                                class="fa fa-rub"
                                                                                aria-hidden="true"></i></li>
                                                                    <li value="USD" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                    ...
                                                                    <li value="EUR" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_currency_dop_2('&euro;')"><i
                                                                                class="fa fa-eur"
                                                                                aria-hidden="true"></i></li>
                                                                </ul>
                                                            </div>
                                            ...
                                            <div class="_1rc8I " data-test="ui-group">
                                                ...
                                                <div class="_2J6fq">
                                                    <div class="_1Mbqb _2futP TNUZk" data-test="ui-slider-input">
                                                        <div class="_3_n91 AePXT _1fswf"
                                                             data-test="ui-slider-input-input">
                                                            <div class="_1DCZo"><input id="cur_period_dop-2" type="text"
                                                                                       readonly="" autocomplete="off"
                                                                                       autocorrect="off"
                                                                                       autocapitalize="off"
                                                                                       spellcheck="off"
                                                                                       class="_2ARmF _2qJ6u"
                                                                                       role="input" value="3 года"
                                                                                       onclick="select_period_dop_2();">
                                                                <ul id="period_dop-2" class="_3IKDE _2cR3J"
                                                                    data-test="ui-select-values">
                                                                    <li value="P1M" label="1 месяц" class="_3NNjg"
                                                                        data-test="ui-menu-item" data-reactid="205"
                                                                        onclick="select_period_srok_dop_2('1 месяц')">1
                                                                        месяц
                                                                    </li>
                                                                    <li value="P3M" label="3 месяца" class="_3NNjg "
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('3 месяца')">3
                                                                        месяца
                                                                    </li>
                                                                    <li value="P6M" label="6 мес¤цев" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('6 месяцев')">6
                                                                        месяцев
                                                                    </li>
                                                                    <li value="P9M" label="9 месяцев" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('9 месяцев')">9
                                                                        месяцев
                                                                    </li>
                                                                    <li value="P1Y" label="1 год" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('1 год')">1 год
                                                                    </li>
                                                                    <li value="P2Y" label="2 года" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('2 года')">2
                                                                        года
                                                                    </li>
                                                                    <li value="P3Y" label="3 года" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('3 года')">3
                                                                        года
                                                                    </li>
                                                                    <li value="P4Y" label="4 года" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('4 года')">4
                                                                        года
                                                                    </li>
                                                                    <li value="P5Y" label="5 лет" class="_3NNjg"
                                                                        data-test="ui-menu-item" data-reactid="213"
                                                                        onclick="select_period_srok_dop_2('5 лет')">5 лет
                                                                    </li>
                                                                    <li value="P6Y" label="6 лет" class="_3NNjg"
                                                                        data-test="ui-menu-item" data-reactid="214"
                                                                        onclick="select_period_srok_dop_2('6 лет')">6 лет
                                                                    </li>
                                                                    <li value="P7Y" label="7 лет" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('7 лет')">7 лет
                                                                    </li>
                                                                    <li value="P8Y" label="8 лет" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_2('8 лет')">8 лет
                                                                    ...
                                                                    <li value="P9Y" label="9 лет" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('9 лет')">9 лет
                                                                    </li>
                                                                    <li value="P10Y" label="10 лет" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('10 лет')">10
                                                                        лет
                                                                    </li>
                                                                    <li value="P15Y" label="15 лет" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('15 лет')">15
                                                                        лет
                                                                    </li>
                                                                    <li value="P20Y" label="20 лет" class="_3NNjg"
                                                                        data-test="ui-menu-item"
                                                                        onclick="select_period_srok_dop_2('20 лет')">20
                                                                        лет
                                                                    </li>
                                                                </ul>
                                                            </div>
                                            ...
                                            <div class="_1rc8I " data-test="ui-group">
                                                ...
                                                <div class="_2J6fq">
                                                    <div class="_1Mbqb _2futP TNUZk" data-test="ui-slider-input">
                                                        <div class="_3_n91 AePXT _1fswf"
                                                             data-test="ui-slider-input-input">
                                                            <div class="_1DCZo"><input id="cur_city_dop-2" type="text"
                                                                                       class="_2ARmF _2qJ6u" value=""
                                                                                       onchange="change_city();Get_OnKr();">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div data-test="ui-select" class="_129hA">
                                                    ...
                                                    <div class="_2J6fq">
                                                        <div class="_1Mbqb _2futP TNUZk" data-test="ui-slider-input">
                                                            <div class="_3_n91 AePXT _1fswf"
                                                                 data-test="ui-slider-input-input">
                                                                <div class="_1DCZo"><input id="cur_target-2" type="text"
                                                                                           readonly=""
                                                                                           class="_2ARmF _2qJ6u _16cFN"
                                                                                           value="Любая"
                                                                                           onclick="select_cur_target_2();">
                                                                    <ul id="target-2" class=" _2cR3J"
                                                                        data-test="ui-select-values">
                                                                        <li value="Любая" class="_3NNjg"
                                                                            data-test="ui-menu-item"
                                                                            onclick="select_target_2('Любая')">Любая
                                                                        </li>
                                                                        <li value="Рефинансирование" class="_3NNjg"
                                                                            data-test="ui-menu-item"
                                                                            onclick="select_target_2('Рефинансирование')">
                                                                            Рефинансирование
                                                                        </li>
                                                                        <li value="Ремонт" class="_3NNjg"
                                                                            data-test="ui-menu-item"
                                                                            onclick="select_target_2('Ремонт')">Ремонт
                                                                        </li>
                                                                        <li value="Обучение" class="_3NNjg"
                                                                            data-test="ui-menu-item"
                                                                            onclick="select_target_2('Обучение')">Обучение
                                                                        </li>
                                                                        </li>
                                                                        <li value="Развитие личного подсобного хозяйства"
                                                                            class="_3NNjg" data-test="ui-menu-item"
                                                                            onclick="select_target_2('Развитие личного подсобного хозяйства')">
                                                                            Развитие личного подсобного хозяйства
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                            ...
                                            <div class="_1rc8I">
                                                <div data-test="ui-select" class="_129hA">
                                                    <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input"><label
                                                                class="_3CBLq _1wJD0">Залог</label>
                                                        <div class="_1DCZo "><input id="zalog_cur-2" type="text"
                                                                                    readonly="" autocomplete="off"
                                                                                    autocorrect="off"
                                                                                    autocapitalize="off"
                                                                                    spellcheck="off"
                                                    ...
                                                    <ul id="zalog-2" class="_3IKDE _2cR3J" data-test="ui-select-values">
                                                        <li value="Неважно" label="Неважно" class="_3NNjg _3R8Y8 _2Karn"
                                                            data-test="ui-menu-item" onclick="select_zalog_2('Неважно')">
                                                            Неважно
                                                        </li>
                                                        <li value="Без залога" label="Без залога" class="_3NNjg _3R8Y8"
                                                            data-test="ui-menu-item"
                                                            onclick="select_zalog_2('Без залога')">Без залога
                                                        </li>
                                                        <li value="Залог имеющейся недвижимости"
                                                            label="Залог имеющейся недвижимости" class="_3NNjg _3R8Y8"
                                                            data-test="ui-menu-item"
                                                            onclick="select_zalog_2('Залог имеющейся недвижимости')">Залог
                                                            имеющейся недвижимости
                                                        </li>
                                                        <li value="Залог имеющегося ТС" label="Залог имеющегося ТС"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_zalog_2('Залог имеющегося ТС')">Залог
                                                            имеющегося ТС
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="_1rc8I">
                                                <div data-test="ui-select" class="_129hA">
                                                    <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input"><label
                                                                class="_3CBLq _1wJD0">Поручительство</label>
                                                        <div class="_1DCZo "><input id="cur_poruch-2" type="text"
                                                                                    readonly="" autocomplete="off"
                                                                                    autocorrect="off"
                                                                                    autocapitalize="off"
                                                                                    spellcheck="off"
                                                    ...
                                                    <ul id="poruch-2" class="_3IKDE _2cR3J" data-test="ui-select-values">
                                                        <li value="Неважно" label="Неважно" class="_3NNjg _3R8Y8 _2Karn"
                                                            data-test="ui-menu-item" onclick="select_poruch('Неважно')">
                                                            Неважно
                                                        </li>
                                                        <li value="Без поручителей" label="Без поручителей"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_poruch_2('Без поручителей')">Без поручителей
                                                        </li>
                                                        <li value="Требуется поручитель" label="Требуется поручитель"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_poruch_2('Требуется поручитель')">Требуется
                                                            поручитель
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="_1rc8I">
                                                <div data-test="ui-select" class="_129hA">
                                                    <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input"><label
                                                                class="_3CBLq _1wJD0">Подтверждение дохода</label>
                                                        <div class="_1DCZo "><input id="cur_podtv_dohod-2" type="text"
                                                                                    readonly="" autocomplete="off"
                                                                                    autocorrect="off"
                                                                                    autocapitalize="off"
                                                                                    spellcheck="off"
                                                                                    class="_2ARmF _2qJ6u _16cFN"
                                                                                    role="input" value="Любое"
                                                                                    onclick="select_cur_podtv_dohod_2();">
                                                            <div class="_2k11- _2V6_I _3E_jV SVDVr _2Z7K9"
                                                                 data-test="ui-select-input-icon">
                                                                <svg class="SdEDi">
                                                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    ...
                                                    <ul id="podtv_dohod-2" class="_3IKDE _2cR3J"
                                                        data-test="ui-select-values">
                                                        <li value="Любое" label="Любое" class="_3NNjg _3R8Y8 _2Karn"
                                                            data-test="ui-menu-item"
                                                            onclick="select_podtv_dohod_2('Любое')">Любое
                                                        </li>
                                                        <li value="Без справок о доходах" label="Без справок о доходах"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_podtv_dohod_2('Без справок о доходах')">Без
                                                            справок о доходах
                                                        </li>
                                                        <li value="Справка в свободной форме"
                                                            label="Справка в свободной форме" class="_3NNjg _3R8Y8"
                                                            data-test="ui-menu-item"
                                                            onclick="select_podtv_dohod_2('Справка в свободной форме')">
                                                            Справка в свободной форме
                                                        </li>
                                                        <li value="Справка по форме банка"
                                                            label="Справка по форме банка" class="_3NNjg _3R8Y8"
                                                            data-test="ui-menu-item"
                                                            onclick="select_podtv_dohod_2('Справка по форме банка')">
                                                            Справка по форме банка
                                                        </li>
                                                        <li value="Справка 2-НДФЛ" label="Справка 2-НДФЛ"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_podtv_dohod_2('Справка 2-НДФЛ')">Справка
                                                            2-НДФЛ
                                                        </li>
                                                        <li value="Справка 3-НДФЛ" label="Справка 3-НДФЛ"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_podtv_dohod_2('Справка 3-НДФЛ')">Справка
                                                            3-НДФЛ
                                                        </li>
                                                        <li value="Справка из ПФР" label="Справка из ПФР"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_podtv_dohod_2('Справка из ПФР')">Справка из
                                                            ПФР
                                                        </li>
                                                        <li value="Выписка по счету" label="Выписка по счету"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_podtv_dohod_2('Выписка по счету')">Выписка по
                                                            счету
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="_1rc8I">
                                                <div data-test="ui-select" class="_129hA">
                                                    <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input"><label
                                                                class="_3CBLq _1wJD0">Форма выдачи</label>
                                                        <div class="_1DCZo "><input id="cur_form_vidach-2" type="text"
                                                                                    readonly="" autocomplete="off"
                                                                                    autocorrect="off"
                                                                                    autocapitalize="off"
                                                                                    spellcheck="off"
                                                                                    class="_2ARmF _2qJ6u _16cFN"
                                                                                    role="input" value="Любая"
                                                                                    onclick="select_cur_form_vidach_2()">
                                                            <div class="_2k11- _2V6_I _3E_jV SVDVr _2Z7K9"
                                                                 data-test="ui-select-input-icon">
                                                                <svg class="SdEDi">
                                                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    ...
                                                    <ul id="form_vidach-2" class="_3IKDE _2cR3J"
                                                        data-test="ui-select-values">
                                                        <li value="Любая" label="Любая" class="_3NNjg _3R8Y8 _2Karn"
                                                            data-test="ui-menu-item"
                                                            onclick="select_form_vidach_2('Любая')">Любая
                                                        </li>
                                                        <li value="Наличными" label="Наличными" class="_3NNjg _3R8Y8"
                                                            data-test="ui-menu-item"
                                                            onclick="select_form_vidach_2('Наличными')">Наличными
                                                        </li>
                                                        <li value="На карту" label="На карту" class="_3NNjg _3R8Y8"
                                                            data-test="ui-menu-item"
                                                            onclick="select_form_vidach_2('На карту')">На карту
                                                        </li>
                                                        <li value="На счет" label="На счет" class="_3NNjg _3R8Y8"
                                                            data-test="ui-menu-item"
                                                            onclick="select_form_vidach_2('На счет')">На счет
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="_1rc8I">
                                                <div data-test="ui-select" class="_129hA">
                                                    <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input"><label
                                                                class="_3CBLq _1wJD0">Срок рассмотрения</label>
                                                        <div class="_1DCZo "><input id="cur_srok_rasm-2" type="text"
                                                                                    readonly="" autocomplete="off"
                                                                                    autocorrect="off"
                                                                                    autocapitalize="off"
                                                                                    spellcheck="off"
                                                                                    class="_2ARmF _2qJ6u _16cFN"
                                                                                    role="input" value="Неважен"
                                                                                    onclick="select_cur_srok_rasm_2()">
                                                            <div class="_2k11- _2V6_I _3E_jV SVDVr _2Z7K9"
                                                                 data-test="ui-select-input-icon">
                                                                <svg class="SdEDi">
                                                                    <use xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    ...
                                                    <ul id="srok_rasm-2" class="_3IKDE _2cR3J"
                                                        data-test="ui-select-values">
                                                        <li value="Неважен" label="Неважен" class="_3NNjg _3R8Y8 _2Karn"
                                                            data-test="ui-menu-item"
                                                            onclick="select_srok_rasm_2('Неважен')">Неважен
                                                        </li>
                                                        <li value="За 1 час" label="За 1 час" class="_3NNjg _3R8Y8"
                                                            data-test="ui-menu-item"
                                                            onclick="select_srok_rasm_2('За 1 час')">За 1 час
                                                        </li>
                                                        <li value="В течение 1 дня" label="В течение 1 дня"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_srok_rasm_2('В течение 1 дня')">В течение 1
                                                            дня
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="_1rc8I _1pC8g"><label id="label_strahov-2" class="_271MP"
                                                                              data-test="ui-checkbox"><input
                                                            id="strahov-2" type="checkbox" class="_13ChN"
                                                            onclick="select_strahov_2();"><span class="zDjae">Личное страхование заёмщика</span></label>
                                            </div>
                                        </div>
                                        <div class="_3W8tQ">
                                            <div class="_1rc8I">
                                                <div data-test="ui-select" class="_129hA">
                                                    <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input"><label
                                                                class="_3CBLq _1wJD0">Регистрация</label>
                                                        <div class="_1DCZo "><input id="cur_registr-2" type="text"
                                                                                    readonly="" autocomplete="off"
                                                                                    autocorrect="off"
                                                                                    autocapitalize="off"
                                                                                    spellcheck="off"
                                                    ...
                                                    <ul id="registr-2" class="_3IKDE _2cR3J" data-test="ui-select-values">
                                                        <li value="Не важно" label="Не важно"
                                                            class="_3NNjg _3R8Y8 _2Karn" data-test="ui-menu-item"
                                                            onclick="select_cur_registr_2('Не важно')">Не важно
                                                        </li>
                                                        <li value="Временная" label="Временная" class="_3NNjg _3R8Y8"
                                                            data-test="ui-menu-item"
                                                            onclick="select_cur_registr_2('Временная')">Временная
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="_1rc8I">
                                                <div class="_3_n91 _1fswf" data-test="ui-input"><label
                                                            class="_3CBLq _1wJD0">Возраст заемщика</label>
                                                    <div class="_1DCZo"><input id="cur_age-2" type="text"
                                                                               autocomplete="off" autocorrect="off"
                                                                               autocapitalize="off" spellcheck="off"
                                                                               class="_2ARmF _2qJ6u" role="input"
                                                                               value="" onchange="Get_PotrKr()"></div>
                                            ...
                                            <div class="_1rc8I">
                                                <div data-test="ui-select" class="_129hA">
                                                    <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input"><label
                                                                class="_3CBLq _1wJD0">Категория заёмщика</label>
                                                        <div class="_1DCZo "><input id="cur_category-2" type="text"
                                                                                    readonly="" autocomplete="off"
                                                                                    autocorrect="off"
                                                                                    autocapitalize="off"
                                                                                    spellcheck="off"
                                                    ...
                                                    <ul id="category-2" class="_3IKDE _2cR3J"
                                                        data-test="ui-select-values">
                                                        <li value="Неважно" label="Неважно" class="_3NNjg _3R8Y8 _2Karn"
                                                            data-test="ui-menu-item"
                                                            onclick="select_cur_category_2('Неважно')">Неважно
                                                        </li>
                                                        <li value="Бюджетные" label="Бюджетные" class="_3NNjg _3R8Y8"
                                                            data-test="ui-menu-item"
                                                            onclick="select_cur_category_2('Бюджетные')">Бюджетные
                                                        </li>
                                                        <li value="Предприниматели" label="Предприниматели"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_cur_category_2('Предприниматели')">
                                                            Предприниматели
                                                        </li>
                                                        <li value="Зарплатные клиенты" label="Зарплатные клиенты"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_cur_category_2('Зарплатные клиенты')">
                                                            Зарплатные клиенты
                                                        </li>
                                                        <li value="Клиенты банка" label="Клиенты банка"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_cur_category_2('Клиенты банка')">Клиенты банка
                                                        </li>
                                                        <li value="Особая категория" label="Особая категория"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_cur_category_2('Особая категория')">Особая
                                                            категория
                                                        </li>
                                                        <li value="Пенсионеры" label="Пенсионеры" class="_3NNjg _3R8Y8"
                                                            data-test="ui-menu-item"
                                                            onclick="select_cur_category_2('Пенсионеры')">Пенсионеры
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="_1rc8I">
                                                <div data-test="ui-select" class="_129hA">
                                                    <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input"><label
                                                                class="_3CBLq _1wJD0">Общий трудовой стаж</label>
                                                        <div class="_1DCZo "><input id="cur_stag-2" type="text"
                                                                                    readonly="" autocomplete="off"
                                                                                    autocorrect="off"
                                                                                    autocapitalize="off"
                                                                                    spellcheck="off"
                                                    ...
                                                    <ul id="stag-2" class="_3IKDE _2cR3J" data-test="ui-select-values">
                                                        <li value="Неважен" label="Неважен" class="_3NNjg _3R8Y8 _2Karn"
                                                            data-test="ui-menu-item"
                                                            onclick="select_cur_stag_2('Неважен')">Неважен
                                                        </li>
                                                        <li value="Менее 1 года" label="Менее 1 года"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_cur_stag_2('Менее 1 года')">Менее 1 года
                                                        </li>
                                                        <li value="1 год и более" label="1 год и более"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_cur_stag_2('1 год и более')">1 год и более
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="_1rc8I">
                                                <div data-test="ui-select" class="_129hA">
                                                    <div class="_3_n91 _1e74P _1fswf" data-test="ui-select-input"><label
                                                                class="_3CBLq _1wJD0">Стаж на последнем месте</label>
                                                        <div class="_1DCZo "><input id="cur_stag_last-2" type="text"
                                                                                    readonly="" autocomplete="off"
                                                                                    autocorrect="off"
                                                                                    autocapitalize="off"
                                                                                    spellcheck="off"
                                                    ...
                                                    <ul id="stag_last-2" class="_3IKDE _2cR3J"
                                                        data-test="ui-select-values">
                                                        <li value="Неважен" label="Неважен" class="_3NNjg _3R8Y8 _2Karn"
                                                            data-test="ui-menu-item"
                                                            onclick="select_cur_stag_last_2('Неважен')">Неважен
                                                        </li>
                                                        <li value="Менее 3 месяцев" label="Менее 3 месяцев"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_cur_stag_last_2('Менее 3 месяцев')">Менее 3
                                                            месяцев
                                                        </li>
                                                        <li value="От 3 до 6 месяцев" label="От 3 до 6 месяцев"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_cur_stag_last_2('От 3 до 6 месяцев')">От 3 до
                                                            6 месяцев
                                                        </li>
                                                        <li value="Более 6 месяцев" label="Более 6 месяцев"
                                                            class="_3NNjg _3R8Y8" data-test="ui-menu-item"
                                                            onclick="select_cur_stag_last_2('Более 6 месяцев')">Более 6
                                                            месяцев
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="_1rc8I _1pC8g"><label id="label_gr-2" class="_271MP"
                                                                              data-test="ui-checkbox"><input id="cur_gr-2"
                                                                                                             type="checkbox"
                                                                                                             class="_13ChN"
                                                                                                             value="0"
                                                                                                             readonly=""
                                                                                                             onclick="select_gr_2()"><span
                                                            class="zDjae">Не являюсь гражданином РФ</span></label></div>
                                        </div>
                                    </div>
                                    <div id="footer_dop_cr-2" class="zPvOY">
                                        <button class="_2sdWW _2OZ3R RaZ2S _3zDyU _3x77s" type="button"
                                                data-test="ui-button">Найдено 32 кредита
                                        </button>
                                        <button class="_2sdWW _2OZ3R _1VABv _3zDyU _3x77s _3Ldwp" type="button">Сбросить
...
<script>$(function () {
    ...
    $(function () {
        $("#slider-range-2").slider({
            ...
            step: 1,
            slide: function (event, ui) {
                $("#price-2").val(ui.values[1] * 1000);
                $("#slider-range_dop-2").slider("option", "values", [1, ui.values[1] * 1000]);
                document.getElementById('price_dop-2').value = ui.values[1] * 1000;
                Get_OnKr();
            }
        });
        $("#price").val($("#slider-range").slider("values", 1) * 1000);
        $("#price-2").val($("#slider-range-2").slider("values", 1) * 1000);
    });</script>
<script>$(function () {
    ...
    $(function () {
        $("#slider-range_dop-2").slider({
            ...
            step: 1,
            slide: function (event, ui) {
                $("#price_dop-2").val(ui.values[1] * 1000);
                $("#slider-range-2").slider("option", "values", [1, ui.values[1] * 1000]);
                document.getElementById('price-2').value = ui.values[1] * 1000;
                Get_OnKr();
            }
        });
        $("#price_dop-2").val($("#slider-range_dop-2").slider("values", 1) * 1000);
    });</script>
<script>
    function show_dop() {
        $('#overlay').show();
    ...
    function clear_dop_2() {
        $("#slider-range_dop-2").slider("option", "values", [1, 102]); //changeFX was 500
        $("#price_dop-2").val(100000); //changeFX was 500
        $("#slider-range-2").slider("option", "values", [1, 102]); //changeFX was 500
        $("#price-2").val(100000); //changeFX was 500
        $("#cur_period-2").val('3 года');
        $("#cur_period_dop-2").val('3 года');
        $("#cur_city_dop-2").val('');
        $("#zalog_cur-2").val('Неважно');
        $("#cur_target-2").val('Любая');
        $("#cur_poruch-2").val('Неважно');
        $("#cur_podtv_dohod-2").val('Любое');
        $("#cur_form_vidach-2").val('Любая');
        $("#cur_srok_rasm-2").val('Неважен');
        $("#cur_registr-2").val('Не важно');
        $("#cur_category-2").val('Неважно');
        $("#cur_stag-2").val('Неважен');
        $("#cur_stag_last-2").val('Неважен');
        select_currency_2("₽");
        Get_OnKr();
    }</script>
...
<script> function select_cur_dop() {
    ...
    function select_cur_dop_2() {
        if ($("#currency_dop-2").css('visibility') == 'hidden') {
            $("#currency_dop-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#currency_dop-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function select_cur() {
    ...
    function select_cur_2() {
        if ($("#currency-2").css('visibility') == 'hidden') {
            $("#currency-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#currency-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function select_cur_target() {
    ...
    function select_cur_target_2() {
        if ($("#target-2").css('visibility') == 'hidden') {
            $("#target-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#target-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function select_cur_poruch() {
    ...
    function select_cur_poruch_2() {
        if ($("#poruch-2").css('visibility') == 'hidden') {
            $("#poruch-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#poruch-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function select_cur_form_vidach() {
    ...
    function select_cur_form_vidach_2() {
        if ($("#form_vidach-2").css('visibility') == 'hidden') {
            $("#form_vidach-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#form_vidach-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function select_cur_srok_rasm() {
    ...
    function select_cur_srok_rasm_2() {
        if ($("#srok_rasm-2").css('visibility') == 'hidden') {
            $("#srok_rasm-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#srok_rasm-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function select_cur_podtv_dohod() {
    ...
    function select_cur_podtv_dohod_2() {
        if ($("#podtv_dohod-2").css('visibility') == 'hidden') {
            $("#podtv_dohod-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#podtv_dohod-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function select_category() {
    ...
    function select_category_2() {
        if ($("#category-2").css('visibility') == 'hidden') {
            $("#category-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#category-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function select_stag() {
    ...
    function select_stag_2() {
        if ($("#stag-2").css('visibility') == 'hidden') {
            $("#stag-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#stag-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function select_stag_last() {
    ...
    function select_stag_last_2() {
        if ($("#stag_last-2").css('visibility') == 'hidden') {
            $("#stag_last-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#stag_last-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function select_registr() {
    ...
    function select_registr_2() {
        if ($("#registr-2").css('visibility') == 'hidden') {
            $("#registr-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#registr-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function select_period() {
    ...
    function select_period_2() {
        if ($("#period-2").css('visibility') == 'hidden') {
            $("#period-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#period-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>
...
<script>function select_period_dop() {
    ...
    function select_period_dop_2() {
        if ($("#period_dop-2").css('visibility') == 'hidden') {
            $("#period_dop-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#period_dop-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function zalog_select() {
    ...
    function zalog_select_2() {
        if ($("#zalog-2").css('visibility') == 'hidden') {
            $("#zalog-2").css({'visibility': 'visible', 'overflow-x': 'visible', 'overflow-y': 'visible'});
        } else {
            $("#zalog-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        }
    }</script>
<script>function price_change_dop() {
    ...
    function price_change_dop_2() {
        a = document.getElementById('price_dop-2').value;
        if (a >= 10000 && a <= 15000000) {
            $("#slider-range_dop-2").slider("option", "values", [1, a / 10000]);
            $("#slider-range-2").slider("option", "values", [1, a / 10000]);
            Get_OnKr();
        }
    }</script>
<script>function price_change() {
    ...
    function price_change_2() {
        a = document.getElementById('price-2').value;
        if (a >= 10000 && a <= 15000000) {
            $("#slider-range-2").slider("option", "values", [1, a / 10000]);
            $("#slider-range_dop-2").slider("option", "values", [1, a / 10000]);
            Get_OnKr();
...
<script>function select_currency(a) {
    ...
    function select_currency_2(a) {
        $("#cur_currency-2").val(a);
        $("#cur_currency_dop-2").val(a);
        $("#currency-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        Get_OnKr();
    }
    ...
    function select_currency_dop_2(a) {
        $("#cur_currency_dop-2").val(a);
        $("#cur_currency-2").val(a);
        $("#currency_dop-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        Get_OnKr();
    ...
    function select_podtv_dohod_2(a) {
        $("#cur_podtv_dohod-2").val(a);
        $("#podtv_dohod-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        Get_OnKr();
    }
    ...
    function select_form_vidach_2(a) {
        $("#cur_form_vidach-2").val(a);
        $("#form_vidach-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        Get_OnKr();
    }
    ...
    function select_srok_rasm_2(a) {
        $("#cur_srok_rasm-2").val(a);
        $("#srok_rasm-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        Get_OnKr();
    }
    ...
    function select_cur_registr_2(a) {
        $("#cur_registr-2").val(a);
        $("#registr-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        Get_OnKr();
    }
    ...
    function select_cur_category_2(a) {
        $("#cur_category-2").val(a);
        $("#category-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        Get_OnKr();
    }
    ...
    function select_cur_stag_last_2(a) {
        $("#cur_stag_last-2").val(a);
        $("#stag_last-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        Get_OnKr();
    }</script>
...
<script>function select_period_srok(a) {
    ...
    function select_period_srok_2(a) {
        $("#cur_period-2").val(a);
        $("#cur_period_dop-2").val(a);
        $("#period-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        Get_OnKr();
    }</script>
<script>
...
<script>function select_period_srok_dop(a) {
    ...
    function select_period_srok_dop_2(a) {
        $("#cur_period_dop-2").val(a);
        $("#cur_period-2").val(a);
        $("#period_dop-2").css({'visibility': 'hidden', 'overflow-x': 'hidden', 'overflow-y': 'hidden'});
        Get_OnKr();
...
<script>function toggle_menu(i) {
    ...
    function toggle_menu_2(i) {
        el = document.getElementsByClassName('-link-2');
        $(".-link-2").removeClass("-active-2");
        $('#navigation-2').attr('data-current', i);
        /*el[i].addClass('-active');*/
    }</script>
<script>function select_strahov() {
    ...
    function select_strahov_2() {
        var c = document.querySelector('#strahov-2');
        if (c.checked) {
            $("#label_strahov-2").addClass('_3QFEG');
        } else {
            $("#label_strahov-2").removeClass('_3QFEG');
        }
        Get_OnKr();
    }
    function select_gr() {
    ...
    function select_gr_2() {
        var gr = document.querySelector('#cur_gr-2');
        if (gr.checked) {
            $("#label_gr-2").addClass('_3QFEG');
        } else {
            $("#label_gr-2").removeClass('_3QFEG');
        }
        Get_OnKr();
    }</script>
    ...
    function Get_OnKr() {
        $.ajax({
            ...
            success: function (response) {
                ...
                if ($('#navigation-2').attr('data-current', '1')) {
                    res.sort(function (a, b) {
                        return a.rating < b.rating;
                    });
                    res.sort();
